...
export const draftQueueTitles = [
  {
    id: "draft-001",
    date: "미발행",
    originalTitle: "초등학생 체육복 관리와 세탁 습관",
    category: "성장/위생",
    naver: "미발행",
    google: "미발행",
    image: "대기",
    keywords: ["체육복", "세탁", "위생", "체취"],
  },
  {
    id: "draft-002",
    date: "미발행",
    originalTitle: "초등학생 여름철 두피 냄새 관리와 머리 감기 습관",
    category: "성장/위생",
    naver: "미발행",
    google: "미발행",
    image: "대기",
    keywords: ["두피냄새", "머리감기", "여름위생"],
  },
];
...
export function getPublishedTitleSet() {
  return new Set(originalPublishedTitles.map((item) => item.originalTitle));
}

export function isPublishedTitle(title: string) {
  return getPublishedTitleSet().has(title);
}
