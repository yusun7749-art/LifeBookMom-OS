...
export const draftQueueTitles: OriginalTitleItem[] = [
  { id: "draft-001", date: "미발행", originalTitle: "초등학생 체육복 관리와 세탁 습관", platform: "Naver", status: "미발행", project: "체육복", keywords: ["체육복", "세탁", "위생"] },
  { id: "draft-002", date: "미발행", originalTitle: "초등학생 여름철 두피 냄새 관리와 머리 감기 습관", platform: "Naver", status: "미발행", project: "두피냄새", keywords: ["두피냄새", "머리감기"] },
  { id: "draft-003", date: "미발행", originalTitle: "초등학생 발 냄새 관리, 양말과 운동화 습관부터 시작해요", platform: "Naver", status: "미발행", project: "발냄새", keywords: ["발냄새", "양말", "운동화"] },
];
