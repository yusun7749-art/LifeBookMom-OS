export const osCore = {
  ...
  currentProject: "Project023-01 Enterprise Integration",
  currentVersion: "OS v2.3.0",
  latestCommit: "LOCAL",
  latestMessage: "Project023-01 Enterprise integration",
...
export const osModules = [
  ...
  { key: "navigator", name: "Navigator Core", status: "READY", href: "/navigator-core", group: "control" },
...
export const osTimeline = [
  {
    project: "Project023-01",
    title: "Enterprise Integration",
    commit: "LOCAL",
    version: "OS v2.3.0",
    status: "BUILDING",
    reason: "흩어진 Center들을 Enterprise Home에서 하나의 운영체제로 연결",
  },
  {
    project: "Project022",
