...
- 무인 발행: 예약 발행·QA·통합 dry-run 실제 검증 완료 전 금지

## 다음 작업 순서

1. Publisher·QA 단위 테스트 및 통합 dry-run 실제 실행
2. 승인용 첫 콘텐츠 요청 JSON 생성 및 QA 검증
3. 첫 콘텐츠 Blogger 초안 생성
4. 이미지 저장소 및 Asset Publisher 방식 확정
5. 이미지 포함 요청 QA 규칙 연결
6. Blogger 예약 발행 실제 검증
7. 통합 발행 버튼 연결
8. 네이버 제목·본문·이미지·임시저장 테스트
