"""One command: topic -> request -> long-form draft -> QA -> Blogger draft."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="생활백서맘 주제 → QA → Blogger 초안")
    ...
    try:
        ...
        return 0 if result["status"] != "BLOCKED_BY_QA" else 2
